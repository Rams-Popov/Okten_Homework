...
//     const h2Surname = document.createElement('h2');
...
//
//     h2Name.innerHTML = simpson.name;
//     h2Surname.innerHTML = simpson.surname;
//     age.innerHTML = simpson.age;
//     info.innerHTML = simpson.info;
//     photo.innerHTML = simpson.photo;
//     div.append(h2Name,h2Surname,age,info,photo);
...
for (const element of coursesArray) {
    ...
    const title = ownDiv.cloneNode();
    const monthDuration = ownDiv.cloneNode();
    const hourDuration = ownDiv.cloneNode();
    const modules = ownDiv.cloneNode();
    const ul = document.createElement('ul');

    title.innerHTML = element.title;
    monthDuration.innerHTML = element.monthDuration;
    hourDuration.innerHTML = element.hourDuration;
    ...
    ownDiv.append(title, monthDuration, hourDuration, modules);
